...
let Clients = [
    ...
    new Client(1, 'vasya', 'ivanov', 'Banana@deneg.net', '+380998765432', [{title: 'potato', price: 8}, {title: 'tomato', price: 4},{title: 'juice', price: 16}]),
    new Client(2, 'petya', 'runas', 'Banana@deneg.net', '+380998765432', [{title: 'milk', price: 22}, {title: 'tomato', price: 4}]),
    new Client(3, 'kostya', 'flipov', 'Banana@deneg.net', '+380998765432', [{title: 'box', price: 2}, {title: 'tomato', price: 4}, {title: 'potato', price: 8}, {title: 'apple', price: 6}]),
    new Client(4, 'ira', 'ivanova', 'Banana@deneg.net', '+380998765432', [{title: 'table', price: 443}, {title: 'tomato', price: 4}]),
    new Client(5, 'garen', 'wex', 'Banana@deneg.net', '+380998765432', [{title: 'tv', price: 17999}]),
